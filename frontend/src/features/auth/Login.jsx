...
const googleLogin = useGoogleLogin({
  ...
  onError: () => { setError('Google sign-in cancelled'); setLoadingGoogle(false); },
});
        ...
        <div className="auth-modern-form-container">
          ...
          <div className="auth-modern-social">
            <button type="button" onClick={() => { setError(''); googleLogin(); }}
              className="btn-social btn-google" disabled={loadingGoogle || loadingEmail}>
          ...
          <form onSubmit={handleSubmit} className="auth-modern-form">
            ...
            <button type="submit" className="btn-modern btn-primary"
              disabled={loadingEmail || loadingGoogle || (showChallenge && !mathAnswer)}>
              {loadingEmail ? <><span className="spinner-modern" />Logging In...</> : 'Login'}
            </button>
          </form>
