        ...
        <div className="auth-modern-form-container">
          ...
          <form onSubmit={handleSubmit} className="auth-modern-form">
                  ...
                  {PASSWORD_RULES.map(rule => {
                    ...
                    return (
                      <div key={rule.id} className={`password-requirement ${passed ? 'passed' : 'failed'}`}>
                        {passed
                          ? <Check size={13} className="req-icon" />
                          : <X size={13} className="req-icon" />
                        }
            ...
            <div className="form-group-modern">
              ...
              <div className="input-with-icon">
                <input
                  ...
                  onChange={handleChange}
                  className={`form-input-modern ${
                    passwordMatch === true ? 'input-success' :
                ...
                <button type="button" onClick={() => setShowConfirmPassword(!showConfirmPassword)}
                  className="password-toggle" aria-label="Toggle confirm password visibility">
            ...
            <button
              ...
              disabled={loading || passwordMatch === false || !isPasswordValid}
            >
              {loading ? (
                <><span className="spinner-modern"></span>Creating Account...</>
              ) : (
                'Create Account'
              )}
            </button>
          ...
          <div className="auth-modern-footer">
            <p>
              ...
              <button onClick={() => navigate('/login')} className="link-modern">Sign In</button>
            </p>
          </div>
        </div>
      </div>
