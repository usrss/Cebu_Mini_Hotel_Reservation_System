...
function StatusBadge({ status, label }) {
  ...
  return (
    <span style={{ background: s.bg, color: s.color, padding: '0.2rem 0.6rem',
    ...
    <div className={styles.page}>
      <div className={styles.header}>
        ...
        {['admin', 'manager'].includes(role) && (
          <button className={styles.revenueBtn}
        ...
        <div className={styles.tableWrap}>
          <table className={styles.table}>
            ...
            <tbody>
              ...
              {payments.length === 0 && (
                <tr><td colSpan={8} className={styles.empty}>No payments found.</td></tr>
              )}
            </tbody>
          </table>
        </div>
